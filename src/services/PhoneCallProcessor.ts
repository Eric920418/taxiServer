...
export class PhoneCallProcessor {
  ...
  private async transcribeAudio(audioPath: string): Promise<string> {
    ...
    const response = await this.openai.audio.transcriptions.create({
      ...
      prompt: '花蓮縣計程車叫車，說話者可能帶有台語腔調（ㄋ/ㄌ混淆、ㄓ/ㄗ混淆）。常見地點：花蓮火車站、東大門夜市、慈濟醫院、門諾醫院、花蓮航空站、太魯閣、七星潭、遠東百貨、家樂福花蓮店、吉安鄉、壽豐鄉。常見路名：中山路、中正路、中華路、林森路、博愛街、民權路、自強路、府前路。取消訂單常用語：不要了、取消、不叫了、不需要了。錄音開頭可能包含系統問候語「大豐您好請說在哪裡搭車」，可能被乘客語音打斷而不完整。請忽略問候語部分，只轉錄乘客說的上車地點和目的地。'
    });

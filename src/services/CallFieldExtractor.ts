...
- 太魯閣 → 太魯閣國家公園遊客中心
- 七星潭 → 七星潭風景區
- 好樂迪/KTV → 好樂迪KTV花蓮店（國聯五路69號）
- 三角形/三角型/三角形pub → 三角形餐酒館（光復街52號）
- 四維/四維高中 → 四維高級中學（中山路717號）
- 丁丁/丁丁藥局 → 丁丁連鎖藥局花蓮店（中山路553號）
- 花中 → 國立花蓮高級中學（府前路1號）
- 花女 → 國立花蓮女子高級中學（民國路90號）
- 公正包子 → 公正包子店（仁愛街46號）
...
## 人名 vs 地址辨識（非常重要）
- 「X 要去 Y」「X 到 Y」格式中，X 通常是客人名字/綽號，Y 是目的地
- 例：「太空人要去車站」→ customer_name="太空人"，destination_address="花蓮火車站"，pickup_address=null
- 例：「小美到好樂迪」→ customer_name="小美"，destination_address="好樂迪KTV花蓮店"，pickup_address=null
- 如果 X 不是已知地標/地址（不含路/街/巷/號），優先判定為人名而非上車地址
- **絕對不要把人名填入 pickup_address**，寧可留 null

## 注意事項
- 花蓮口語可能會用簡稱，請對照地標表轉換
- 如果只提到「來我家」或「來接我」，pickup_address 設為 null（需靠來電號碼地址簿查詢）
- 如果上車地址不明確（只有人名或綽號），pickup_address 設為 null，不要猜測
